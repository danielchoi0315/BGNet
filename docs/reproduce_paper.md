...
1. Convert a research **window / encoder** checkpoint with `convert_research_checkpoint(...)`
...
For public benchmarking, prefer wrapping BGNet inside Braindecode or your own training/evaluation
stack rather than trying to recreate the original cluster orchestration in this repo.
